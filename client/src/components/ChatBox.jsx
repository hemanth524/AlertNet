...
const ChatBox = ({ incidentId, receiverId }) => {
    ...
    return (
        <div className="max-w-lg mx-auto bg-slate-800 rounded-xl p-4 shadow-md border border-slate-700">
            <h2 className="text-center text-lg font-semibold text-red-400 mb-2">
                💬 Chat with Reporter
            </h2>
            <div className="h-64 overflow-y-auto bg-slate-900 p-3 rounded-md mb-3 space-y-2">
